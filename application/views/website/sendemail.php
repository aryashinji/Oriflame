    ...
    <section id="contact" >
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <form name="sentMessage" action="<?php echo site_url('member/sendEmail');?>" id="contactForm" method="POST" novalidate>
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <input type="subject" class="form-control" placeholder="Subject *" name="subject" id="subject" required data-validation-required-message="Please enter your subject">
                                    <p class="help-block text-danger"></p>
                                </div>
                            </div>
                            <div class="col-md-6">
